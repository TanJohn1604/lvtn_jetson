...
class serial_detect(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            if (timer_2 - timer_3 > 0.1)  and (flag_roi == 0) and (flag_frame_dautien == 1) :
                flag_roi = 1
                timer_4 = time.time()
                if huong_roi==1:
                    self.spilitdata[0] = 1
            ...
            if (flag_roi == 1) and (timer_2 - timer_4 > 0.5)  and (flag_ketthuc == 0):
                self.spilitdata[1] = 1
                flag_ketthuc = 1
                timer_5 = time.time()

            if (timer_2 - timer_5 > 1.5) and flag_ketthuc == 1:
                huong_roi = 0
                flag_ketthuc = 0
                flag_roi = 0
                flag_frame_dautien = 0
